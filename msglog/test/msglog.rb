...
module Cougaar
  ...
  module States
    ...
    class SwitchProtocols < Cougaar::State
      ...
      def process
        puts "Waiting " + @timeout.to_s + " for Switch to " + @protocol + " for messages to " + @node
        loop = true
        while loop
      ...
      def unhandled_timeout
        puts "Timed out after " + @timeout.to_s + " waiting for Switch to " + @protocol + " for messages to " + @node
