...
rm SC-1AD-NEW-AL-RULES-MSGLOG-MSGAUDIT.xml.rb
...
ruby ../../config/bin/transform_society.rb -i SC-1AD-NEW-AL-RULES.xml.rb -r msglog-full-tic-msgaudit.rulex -o SC-1AD-NEW-AL-RULES-MSGLOG-MSGAUDIT.xml.rb
