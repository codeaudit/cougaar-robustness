...
public class StoreAndForwardLinksStatusDiagnosis extends Diagnosis
{
    public StoreAndForwardLinksStatusDiagnosis(String assetName, Object initialValue, ServiceBroker serviceBroker) 
	throws IllegalValueException, TechSpecNotFoundException {
	super(assetName, initialValue, serviceBroker);
    }

    public StoreAndForwardLinksStatusDiagnosis(String assetName, ServiceBroker serviceBroker) 
    ...
    /**
     * Returns a verbose pretty-printed representation for a StoreAndForwardLinksStatusDiagnosis.
     */
    public String dump() {
	return "\n" +
            "<StoreAndForwardLinksStatusDiagnosis:\n" +
	    "   assetID = " + getAssetID() + "\n" +
