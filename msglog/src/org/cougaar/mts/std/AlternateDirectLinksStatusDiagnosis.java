...
public class AlternateDirectLinksStatusDiagnosis extends Diagnosis
{
    public AlternateDirectLinksStatusDiagnosis(String assetName, Object initialValue, ServiceBroker serviceBroker) 
	throws IllegalValueException, TechSpecNotFoundException {
	super(assetName, initialValue, serviceBroker);
    }

    public AlternateDirectLinksStatusDiagnosis(String assetName, ServiceBroker serviceBroker) 
    ...
    /**
     * Returns a verbose pretty-printed representation for a AlternateDirectLinksStatusDiagnosis.
     */
    public String dump() {
	return "\n" +
            "<AlternateDirectLinksStatusDiagnosis:\n" +
	    "   assetID = " + getAssetID() + "\n" +
