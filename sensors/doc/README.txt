...
PingRequests are generated by the PingFactory in the PingDomain,
so the following line must be added to the requesting agent's .ini file.

  Node.AgentManager.Agent.DomainManager.Domain = org.cougaar.tools.robustness.sensors.PingDomain(ping)
