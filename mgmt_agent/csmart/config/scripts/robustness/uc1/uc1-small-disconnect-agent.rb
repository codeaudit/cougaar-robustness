...
Cougaar.new_experiment("UC1_Small_1AD_Tests").run(1) {
  ...
  do_action "KillAgent", "GlobalAir" #Since this is already planned disconnect, shouldn't be restart in that 500 secondes.
  do_action "KillAgent", "1-35-ARBN" # Should restart immediately
