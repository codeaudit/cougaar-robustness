...
Cougaar.new_experiment("ARUC1_Planned_Disconnect").run(1) {
...
# Deconfliction start
  do_action "Sleep", 30.seconds
  do_action "MonitorProtocolSelection"
  do_action "MonitorMsglogEnabling"
#  do_action "MonitorPlannedDisconnectExpired"
  do_action "MonitorDisconnectionEvents"
  do_action "StartPlannedDisconnect", "REAR-A-NODE", 600
  wait_for  "PlannedDisconnectStarted", "REAR-A-NODE"
  do_action "DisableNetworkInterfaces", "REAR-A-NODE"
  do_action "Sleep", 10.minutes
  do_action "EnableNetworkInterfaces", "REAR-A-NODE"
  do_action "EndPlannedDisconnect", "REAR-A-NODE"
#  wait_for  "ReconnectConfirmed", "REAR-A-NODE"
# Deconfliction end
