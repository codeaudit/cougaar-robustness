...
public class DisconnectApplicabilityCondition extends DefenseApplicabilityBinaryCondition
{
    ...
    public static DisconnectApplicabilityCondition findOnBlackboard(String assetType, String assetID, BlackboardService blackboard) {
        ...
        DisconnectApplicabilityCondition rtc = null;
        Collection c = blackboard.query(pred);
        Iterator iter = c.iterator();
        //if (logger.isDebugEnabled()) logger.debug(new Integer(c.size()).toString());
        while (iter.hasNext()) {
           rtc = (DisconnectApplicabilityCondition)iter.next();
