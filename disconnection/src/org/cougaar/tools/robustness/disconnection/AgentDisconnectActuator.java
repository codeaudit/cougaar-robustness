 ...
 * Class.java
 *
 * Created on July 14, 2004, 10:15 AM
 */
...
public class AgentDisconnectActuator extends Action
{

    public AgentDisconnectActuator(String assetName, ServiceBroker serviceBroker)
	throws TechSpecNotFoundException {
        super(assetName, serviceBroker);
    }
    
    public AgentDisconnectActuator(String assetName, Set initialValuesOffered, ServiceBroker serviceBroker)
	throws IllegalValueException, TechSpecNotFoundException {
	super(assetName, initialValuesOffered, serviceBroker);
    }

    public AgentDisconnectActuator(AgentDisconnectActuator action) {
	super(action);
    }
    ...
    /**
     * Returns a verbose pretty-printed representation for a AgentDisconnectActuator.
     */
    public String dump() {
	return "\n" +
            "<AgentDisconnectActuator:\n" +
	    "   assetID = " + getAssetID() + "\n" +
