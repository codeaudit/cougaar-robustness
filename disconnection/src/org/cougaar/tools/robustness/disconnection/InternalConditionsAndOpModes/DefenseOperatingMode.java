...
public class DefenseOperatingMode extends OMCBase
       implements Persistable, Serializable, Relay.Source, Relay.Target, UniqueObject
{
     ...
     */
    public String getExpandedName() { return assetType+":"+assetName; }
    ...
    public void setValue(Comparable newValue) {
        // System.out.println("****** DefOpMode/setValue "+newValue);
