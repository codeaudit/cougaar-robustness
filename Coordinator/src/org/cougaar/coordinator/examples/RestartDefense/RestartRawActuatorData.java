...
class RestartRawActuatorData implements NotPersistable, Serializable
{
    String assetName;
    Set possibleValues;
    Set valuesOffered;
    ...
    RestartRawActuatorData(String assetName, Set possibleValues, Set valuesOffered, Set permittedValues, Object actionValue) {
