...
import org.cougaar.coordinator.techspec.AssetManagerPlugin;
...
class EventInstanceCollection extends Model
{
    ...
    public String toString( )
    {
        ...
        Enumeration enumeration = _event_instance_hash.elements();
        while( enumeration.hasMoreElements() )
        {
            EventInstanceModel event = (EventInstanceModel) enumeration.nextElement();
