...
public class BeliefUpdate extends Object
{
     ...
     * @param asd The asset state descriptor for this belief state
     * @return An AssetBeliefState that is the a priori probabilities
     * for the asset state descriptor being in the various states.
     * @see 
     */
     ...
     *
     * @param asset_name The name of the asset
     * @param asd The asset state descriptor
     ...
     * of diagnoses.
     *
     * @param asd The asset state descriptor that the defsne is monitoring
     * @param composite_diagnosis A vector of DiagnosisComponent
     * objects that have the diagnosis for each defense, 
     * @return An AssetBeliefStatebject with the new estimates of the state
     *         of the asset descriptor
            ...
            throws BelievabilityException 
    {
        ...
        AssetBeliefState prev_belief
                = getInitialBelief( _asset_model.getAssetName(), 
                                    asd );
