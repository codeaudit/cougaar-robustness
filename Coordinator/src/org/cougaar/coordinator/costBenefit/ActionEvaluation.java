...
public class ActionEvaluation implements Comparable {
    ...
    public String getActionName() { return getAction().getClass().toString();  }
...
//    public double getSelectionScore() { return selectionScore; }
    ...
    private boolean alreadyActive(String actionName, String variantName, Collection activeActions) {
        ...
        while (iter.hasNext()) {
            ...
            if (thisAction.getClass().getName().equals(actionName) && variantName.equals(thisAction.getValue().getAction())) return true;
        }
        return false;
    }
