        ...
        while (actionsIter.hasNext()) {
            ...
            try {
               ...
               if (atsi.getActionType() == ActionTechSpecInterface.CORRECTIVE_ACTIONTYPE) {
                    ...
                    AssetStateDimension baseStateDimension = mediatedTechSpecMap.getBaseDimension(thisAction.getClass().toString(), diagnosisTechSpecService);
                    AssetStateDimension compensatedStateDimension = mediatedTechSpecMap.getCompensatedDimension(thisAction.getClass().toString(), diagnosisTechSpecService);
